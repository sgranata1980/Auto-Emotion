<?php
/**
 * Template Name: Karriere – Serviceassistent/in
 *
...
<div class="section-heading">
	<h1 class="section-heading__title"><?php esc_html_e( 'Serviceassistent/in / Automobilkauffrau/-mann (m/w/d) gesucht', 'auto-emotion' ); ?></h1>
</div>
...
<form class="application-form" method="post" enctype="multipart/form-data" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
	...
	<input type="hidden" name="bewerbung_stelle" value="Serviceassistent/in / Automobilkauffrau/-mann (m/w/d)">
