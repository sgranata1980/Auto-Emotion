<?php
/**
 * Template Name: Karriere – Hochvolttechniker
 *
...
<div class="section-heading">
	<h1 class="section-heading__title"><?php esc_html_e( 'Hochvolttechniker / Hochvoltexperte (m/w/d) gesucht', 'auto-emotion' ); ?></h1>
</div>
