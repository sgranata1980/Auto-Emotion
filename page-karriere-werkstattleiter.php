<?php
/**
 * Template Name: Karriere – Werkstattleiter
 *
...
<div class="section-heading">
	<h1 class="section-heading__title"><?php esc_html_e( 'Werkstattleiter (m/w/d) gesucht', 'auto-emotion' ); ?></h1>
</div>
...
<form class="application-form" method="post" enctype="multipart/form-data" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
	...
	<input type="hidden" name="bewerbung_stelle" value="Werkstattleiter (m/w/d)">
